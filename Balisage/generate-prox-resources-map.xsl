        ...
        <resource-map>
            ...
            <!--<wrapper-pipeline>
                <resource>
                    ...
                    <url>file://Users/System/Documents/SGML/DTD/Process-XML/XSLT/process2bat.xsl</url>
                    <name>xslt2bat</name>
                </resource>
                <resource>
                    <urn>URN-CONFIG-XML-XSLT2BAT<!-\- XML file with CLASSPATH -\-></urn>
                    <url>file://Users/System/Documents/SGML/DTD/Process-XML/XSLT/prox-xslt2bat-configuration.xml</url>
                    <name>xslt2bat-config</name>
                </resource>
                <resource>
                    <urn>URN-WRAPPER-XPROC<!-\- XProc Wrapper Pipeline -\-></urn>
                    <url>file://Users/System/Documents/SGML/DTD/Process-XML/XSLT/prox-wrap.xpl</url>
        ...
        <prox>
            ...
            <blueprints>
                <resource id="id-prox-blueprint">
                    ...
                    <url><!--file:/Users/System/Documents/SGML/DTD/Process-XML/XSLT/processes-normalized-cosml-demo-nu.xml--></url>
                    <name></name>
                </resource>    
            </blueprints>
            ...
            <instances>
                <resource id="id-prox-saved-instance">
                    ...
                    <url><!--file:///Users/System/Documents/SGML/DTD/Process-XML/XSLT/prox-instance.xml--></url>
                    <name></name>
                </resource>
            </instances>
        </prox>
