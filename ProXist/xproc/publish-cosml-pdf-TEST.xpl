...
<p:declare-step 
    ...
    <p:input port="document">
        <p:document href="http://localhost:8080/exist/rest/db/docs/pdftest/test-root.xml"/>
    </p:input>
    
    <!-- Stylesheets -->
    <p:input port="stylesheet">
        <p:document href="http://localhost:8080/exist/rest/db/docs/cosml/system/xslfo/cos-fo-internal.xsl"/>
    </p:input>
    
    <p:input port="stylesheet-norm">
        <p:document href="http://localhost:8080/exist/rest/db/docs/cosml/system/xslfo/normalize.xsl"/>
    </p:input>
...
<!--        <p:data href="cosml.dtd"/>-->
    ...
    <!-- Options -->
    <p:option name="pdf" select="'http://localhost:8080/exist/rest/db/docs/pdftest/test-out.pdf'"/>
    ...
    <p:store><!-- doctype-public="-//COS//DTD COSML 1.0//ISO10646" doctype-system="cos.dtd" -->
        <p:with-option name="href" select="'xmldb:exist:///db/docs/pdftest/normalized.xml'"/><!-- //e:/SGML/DTD/Cassis/XProc/ -->
        <p:input port="source">
