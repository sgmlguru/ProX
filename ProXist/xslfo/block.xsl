            ...
            <xsl:when test="(@height &gt; @width) and not(ancestor::step)">
              <xsl:attribute name="content-height">
                <xsl:choose>
                  ...
                  <xsl:when test="@height &gt; '220' and (/*/@role != '2-col' or not(/*/@role))">
            ...
            <xsl:when test="(@height &lt; @width) and not(ancestor::step)">
              <xsl:attribute name="content-width">
                <xsl:choose>
                  ...
                  <xsl:when test="@width &gt; '350' and (/*/@role != '2-col' or not(/*/@role))">
        ...
        <xsl:when test="@width != '' and not(@height)">
          <xsl:attribute name="content-width">
            <xsl:choose>
              ...
              <xsl:when test="@width &gt; '300' and (/*/@role != '2-col' or not(/*/@role))">
        ...
        <xsl:when test="not(@width) and @height != ''">
          <xsl:attribute name="content-height">
            <xsl:choose>
              ...
              <xsl:when test="@height &gt; '300' and (/*/@role != '2-col' or not(/*/@role))">
                <xsl:value-of select="concat('300','px')"/>
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="concat(@height,'px')"/>
