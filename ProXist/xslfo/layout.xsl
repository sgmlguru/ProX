...
<xsl:stylesheet
    ...
    <fo:root
      ...
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="left-TOC" xsl:use-attribute-sets="left-page">
          <fo:region-body xsl:use-attribute-sets="region-toc-left">
            <xsl:choose>
              <xsl:when test="$demo = 'envac'">
                <xsl:attribute name="column-count">2</xsl:attribute>
                <xsl:attribute name="column-gap">6mm</xsl:attribute>
              </xsl:when>
            </xsl:choose>
          </fo:region-body>
          <fo:region-before extent="{$region.before.extent}"/>
        ...
        <fo:simple-page-master master-name="right-TOC" xsl:use-attribute-sets="right-page">
          <fo:region-body xsl:use-attribute-sets="region-toc-right">
            <xsl:choose>
              <xsl:when test="$demo = 'envac'">
                <xsl:attribute name="column-count">2</xsl:attribute>
                <xsl:attribute name="column-gap">6mm</xsl:attribute>
        ...
        <fo:simple-page-master master-name="left-index" xsl:use-attribute-sets="left-page">
          <fo:region-body xsl:use-attribute-sets="region-index-left">
            <xsl:choose>
              <xsl:when test="$demo = 'envac'">
                <xsl:attribute name="column-count">2</xsl:attribute>
                <xsl:attribute name="column-gap">6mm</xsl:attribute>
        ...
        <fo:simple-page-master master-name="right-index" xsl:use-attribute-sets="right-page">
          <fo:region-body xsl:use-attribute-sets="region-index-right">
            <xsl:choose>
              <xsl:when test="$demo = 'envac'">
                <xsl:attribute name="column-count">2</xsl:attribute>
                <xsl:attribute name="column-gap">6mm</xsl:attribute>
        ...
        <!-- Demo page masters (see demo.xsl) -->
        <xsl:if test="$demo = 'cargotec'">
          <xsl:call-template name="cargotec-page-masters"/>
        </xsl:if>
        ...
        <fo:page-sequence-master master-name="meta-data">
          <fo:repeatable-page-master-alternatives>
            <fo:conditional-page-master-reference master-reference="right-meta" odd-or-even="odd"/>
            <fo:conditional-page-master-reference master-reference="left-meta" odd-or-even="even"/>
          </fo:repeatable-page-master-alternatives>
        </fo:page-sequence-master>

        <fo:page-sequence-master master-name="TOC">
          <fo:repeatable-page-master-alternatives>
            <fo:conditional-page-master-reference master-reference="right-TOC" odd-or-even="odd"/>
            <fo:conditional-page-master-reference master-reference="left-TOC" odd-or-even="even"/>
          </fo:repeatable-page-master-alternatives>
        </fo:page-sequence-master>
        ...
        <fo:page-sequence-master master-name="back">
          <fo:repeatable-page-master-alternatives>
            <fo:conditional-page-master-reference master-reference="right-back" odd-or-even="odd"/>
              <!--blank-or-not-blank="not-blank"/>-->
            <fo:conditional-page-master-reference master-reference="left-back" odd-or-even="even"/>
              <!--blank-or-not-blank="not-blank"/>-->
          </fo:repeatable-page-master-alternatives>
        </fo:page-sequence-master>
        ...
        <fo:page-sequence-master master-name="index">
          <fo:repeatable-page-master-alternatives>
            <fo:conditional-page-master-reference master-reference="right-index" odd-or-even="odd"/>
            <fo:conditional-page-master-reference master-reference="left-index" odd-or-even="even"/>
          </fo:repeatable-page-master-alternatives>
        </fo:page-sequence-master>
        ...
        <!-- Demo page sequence masters (see demo.xsl) -->
        <xsl:if test="$demo = 'cargotec'">
          <xsl:call-template name="cargotec-page-sequence-masters"/>
        </xsl:if>
  ...
  <xsl:template name="total-page-count">
    <fo:block id="id-last-page"></fo:block>
  </xsl:template>
