...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:if test="$page.headers = '1'">
            <xsl:choose>
                ...
                <xsl:when test="$demo = 'gunnebo'">
                    <xsl:call-template name="gunnebo-basic-headers"/>
                </xsl:when>
                <!-- Envac demo -->
                <xsl:when test="$demo = 'envac'">
                    <xsl:call-template name="envac-basic-headers"/>
                </xsl:when>
                
                <!-- Standard COS Headers -->
                <xsl:otherwise>
                    <!-- Left Page Header -->
    ...
    <xsl:template name="region-after">
        <xsl:choose>
            ...
            <!-- Gunnebo demo -->
            <xsl:when test="$demo = 'gunnebo'">
                <xsl:call-template name="gunnebo-basic-footers"/>
            </xsl:when>
            <!-- Envac demo -->
            <xsl:when test="$demo = 'envac'">
                <xsl:call-template name="envac-basic-footers"/>
            </xsl:when>
            
            <!-- Standard COS Footers -->
            <xsl:otherwise>
                <!-- Left Page Footer -->
